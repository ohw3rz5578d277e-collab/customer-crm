...
body[data-crm-owner-view="customers"] [data-crm-owner-operational="1"],body[data-crm-owner-view="search"] [data-crm-owner-operational="1"],
body[data-crm-owner-view="customers"] #crmTodayDashboard,body[data-crm-owner-view="search"] #crmTodayDashboard,
body[data-crm-owner-view="customers"] #crmReservationStatus,body[data-crm-owner-view="search"] #crmReservationStatus,
body[data-crm-owner-view="customers"] #crmDeliveryDeadlinePanel,body[data-crm-owner-view="search"] #crmDeliveryDeadlinePanel,
body[data-crm-owner-view="customers"] #crmLegacyOperations,body[data-crm-owner-view="search"] #crmLegacyOperations,
body[data-crm-owner-view="customers"] #crmTodayFilterPanel,body[data-crm-owner-view="search"] #crmTodayFilterPanel,
body[data-crm-owner-view="customers"] #crmGrowthPanel,body[data-crm-owner-view="search"] #crmGrowthPanel,
body[data-crm-owner-view="customers"] .crm-growth-panel,body[data-crm-owner-view="search"] .crm-growth-panel,
body[data-crm-owner-view="customers"] .crm-today-dash,body[data-crm-owner-view="search"] .crm-today-dash,
body[data-crm-owner-view="customers"] .crm-delivery-panel,body[data-crm-owner-view="search"] .crm-delivery-panel,
body[data-crm-owner-view="customers"] [data-crm-owner-today],body[data-crm-owner-view="search"] [data-crm-owner-today],
body[data-crm-owner-view="customers"] [data-crm-owner-operational-section],body[data-crm-owner-view="search"] [data-crm-owner-operational-section]{display:none!important}
...
const api={showToday,showCustomers,showSearch,showLine,getCurrentView,getMetrics:()=>({...metrics})};
...
function boot(){window.__crmOwnerView=api;startBootstrapObserver();if(mobile())api.showToday({scroll:false})}
