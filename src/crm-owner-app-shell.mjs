...
.crm-owner-shell-v2 .app>h1:first-child,.crm-owner-shell-v2 #crmOwnerWorkspaceContent>.app>h1,.crm-owner-shell-v2 #crmOwnerUtilityBar{display:none!important}
...
@media(max-width:767px){
 ...
 body.crm-owner-shell-v2[data-crm-owner-view] #crmMktNav{display:none!important}
