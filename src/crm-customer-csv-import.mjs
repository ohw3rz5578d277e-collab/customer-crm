...
async function previewCsv(){if(!csvText){status('<div class="crm-csv-warn">CSVファイルを選択してください。</div>');return}status('確認中…');try{renderPreview(await api('/api/customer-csv-import/preview',{csv_text:csvText}))}catch(e){status('<div class="crm-csv-error">'+esc(e.message)+'</div>')}}
