...
if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',()=>{schedule();observe()},{once:true});else{schedule();observe()}mq.addEventListener?.('change',schedule);
})();
<\/script>`;
