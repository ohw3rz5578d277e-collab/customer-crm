...
(()=>{
  ...
  const hideWords = ['顧客リストへ','顧客リスト','状態確認','ユーザー管理','ユーザー追加','ログアウト'];
  ...
  function boot(){makeBottomNav();makeSideMenu();clean();}
