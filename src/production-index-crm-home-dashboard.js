...
document.addEventListener('crm:owner-view-change',e=>{if(e.detail?.view==='today')load()});mount();})();
</script>`;
  // Use a replacer callback so '$' inside injected JavaScript is preserved literally.
