...
document.addEventListener('crm:owner-view-change',e=>{if(e.detail?.view==='today')load()});document.readyState==='loading'?document.addEventListener('DOMContentLoaded',mount):mount();})();
</script>`;
