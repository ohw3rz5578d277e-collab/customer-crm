...
pass('expired ID token fails closed',validateVerifiedMemberLineIdTokenPayload({...verifiedPayload,exp:now-__test.CLOCK_SKEW_SECONDS-1},{client_id:clientId,nonce,now_seconds:now}).status==='line_id_token_expired');
