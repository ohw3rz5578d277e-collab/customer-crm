...
pass('production entry sanitizes legacy visuals before Customer360 marketing and daily operations',entrySrc.includes('const canonicalBase=stripLegacyOwnerVisualAssets(html);\n  const withMarketing=injectCustomer360Marketing(canonicalBase);\n  const withDailyOperations=injectCustomerListDailyOperations(withMarketing);'));
