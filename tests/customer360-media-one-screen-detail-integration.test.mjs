...
assert.match(mediaUi,/crmCustomerAvatarHero/,'profile image hero missing from one-screen detail');
assert.match(mediaUi,/画像を変更/,'profile image change action missing');
assert.match(mediaUi,/\[data-open\],\[data-direct-customer\]/,'direct fallback customer opener missing');
