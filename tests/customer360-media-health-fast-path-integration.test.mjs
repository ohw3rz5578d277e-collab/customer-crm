...
const healthCall='const ownedHealth=await handleProductionHealthRequest(request,env)';
const mediaCall='const mediaApi=await handleCustomer360MediaRequest(request,env)';
const downstreamCall='let response=await app.fetch(request,env,ctx)';
